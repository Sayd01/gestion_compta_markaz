...
import ci.saydos.markazcompta.utils.CriteriaUtils;
...
public interface DepenseRepository extends JpaRepository<Depense, Integer>, _DepenseRepository {
    ...
    /**
     * Finds Depense by using typeDepense as a search criteria.
     *
     * @param typeDepense
     * @return An Object Depense whose typeDepense is equals to the given typeDepense. If
     * no Depense is found, this method returns null.
     */
     ...
     * no Depense is found, this method returns null.
     */
    @Query("select e from Depense e where e.chargeFixe.id = :idChargeFixe and e.isDeleted = :isDeleted")
    ...
    default String generateCriteria(DepenseDto dto, HashMap<String, java.lang.Object> param, Integer index, Locale locale) throws Exception {
        ...
        if (dto != null) {
            ...
            if (dto.getTypeDepense() != null) {
                listOfQuery.add(CriteriaUtils.generateCriteria("typeDepense", dto.getTypeDepense(), "e.typeDepense", "enum", dto.getTypeDepenseParam(), param, index, locale));
            }
            ...
            if (dto.getIdChargeFixe() != null && dto.getIdChargeFixe() > 0) {
                listOfQuery.add(CriteriaUtils.generateCriteria("idChargeFixe", dto.getIdChargeFixe(), "e.chargeFixe.id", "Integer", dto.getIdChargeFixeParam(), param, index, locale));
            }
            ...
            if (Utilities.notBlank(dto.getChargeFixeCode())) {
                listOfQuery.add(CriteriaUtils.generateCriteria("chargeFixeCode", dto.getChargeFixeCode(), "e.chargeFixe.code", "String", dto.getChargeFixeCodeParam(), param, index, locale));
            }
